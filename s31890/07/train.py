...
train_ds, val_ds, test_ds, info = data.get_wine()
...
def build_model(hp):
    return model.create_model_with_params(
        ...
        units_per_dense=hp.Int('units_per_dense', 32, 512, step=32),
...
# Optionally reload without calling the search. Not needed as the search method will reload autmatically.
# tuner.reload()
tuner.search(
    train_ds,
